...
(function( factory ) {
	...
	function _fnScrollDraw ( settings )
	{
		...
		if (settings.aiDisplay.length) {
			...
			// WA for incorrect 1st col size with colspan doesn't work, from: https://datatables.net/forums/discussion/78330/wrong-column-size-when-i-use-colspan-in-first-row-second-post
			...
			// 		this.style.width = colSizes[i].width + 'px';
			// 	}
			// });
		}
